...
from scripts_stock.download_data.cash_flow.hangye_cash_flow import *
...
class DownloadBankuaiCashFlowData(DownloadHangyeCashFlowData):
    def __init__(self, ProjectDir):
        # self.stock_list = GetDataFromDB.db_get_hs300_list(if_str=True)
        self.save_tmp_txt_dir = ProjectDir.download_data_dir_bankuai_cash_flow
...
if __name__ == "__main__":
    DownloadBankuaiCashFlowData(DownloadHangyeCashFlowData).main_run()
