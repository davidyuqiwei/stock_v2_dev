...
class DownloadBankuaiCashFlowData(ProjectDir):
    def __init__(self, ProjectDir):
        ...
        print("=========")
        print(ProjectDir.parse_data_dir_bankuai_cash_flow)
    ...
    def download_bankuai_cash_flow_txt(self):
        ...
        for index,url_in in enumerate(url_list):
            ...
            self.final_data_name = os.path.join(
                ProjectDir.parse_data_dir_bankuai_cash_flow, data_name.replace(".txt", ".csv"))
...
if __name__ == "__main__":
    DownloadBankuaiCashFlowData(ProjectDir).main_run()