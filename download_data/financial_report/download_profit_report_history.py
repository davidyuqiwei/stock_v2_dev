...
class DownloadFinReport(ProjectDir):
    def __init__(self, ProjectDir):
        ...
        self.final_data_name = os.path.join(
            self.save_csv_dir, "profit_report_history.csv")

    def download_tmp_txt(self, page_num, report_date):
        page_num = str(page_num)
        save_name = os.path.join(
            self.save_tmp_txt_dir, str(page_num) + "_"+str(report_date) + ".txt")
        ...
        url1 = f"https://datacenter-web.eastmoney.com/api/data/v1/get?callback=jQuery112304448470222379983_1734318038997&sortColumns=NOTICE_DATE%2CSECURITY_CODE&sortTypes=-1%2C-1&pageSize=50&pageNumber={page_num}&reportName=RPT_DMSK_FN_INCOME&columns=ALL&filter=(SECURITY_TYPE_CODE+in+(%22058001001%22%2C%22058001008%22))(TRADE_MARKET_CODE!%3D%22069001017%22)(REPORT_DATE%3D%27{report_date}%27)"
